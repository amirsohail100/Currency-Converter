...
- **Cosmic Starry Animation:** Implemented a deep-space background featuring multi-layered twinkling CSS stars for an immersive, non-distracting visual experience.
- **Dark & Light Mode Switcher:** Includes a responsive theme toggle switch supporting dark and light themes with dynamic CSS variables.
- **High Contrast Component Layout:** Enhanced contrast ratios between background, glass card container, input fields, and action buttons to prevent visual merging.
...
| :------------------ | :------------------- | :----------------------------------------------------------------------------------------- |
| 🌐 **`index.html`** | Structural Blueprint | Hosts semantic input fields, country code flags, theme switcher, and dynamic cards.        |
| 🎨 **`style.css`**  | Visual Presentation  | Manages cosmic starry animations, theme variables, focus states, and responsiveness.       |
...
- **Visual Engine:** Custom CSS3 (Flexbox Matrix Alignment, Keyframe Animations, Theme Variables)
